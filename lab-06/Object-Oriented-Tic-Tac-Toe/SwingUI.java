...
/**
 * A graphical Swing-based user interface for Tic-Tac-Toe.
 * Displays a 3x3 grid of buttons with a status bar at the top.
 * Supports human vs human or human vs AI modes.
 * Implements {@link TicTacToeUI} and {@link GameListener}.
 */
public class SwingUI implements TicTacToeUI {
    ...
    /**
     * Initializes and displays the Swing GUI window, then starts the game loop.
     ...
     * @param aiPlaysAs  the mark the AI plays as
     */
    @Override
