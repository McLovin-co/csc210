// Scatter3DPlotWithTimeExport — Scatter3DPlotWithTime plus a "Export PNG" button.
// Related variants: Scatter3DPlot.java (baseline), Scatter3DPlotFromFile.java,
//                   Scatter3DPlotWithTime.java (same as this without export).
